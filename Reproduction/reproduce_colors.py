...
# import sys
# sys.path.insert(0, 
# sys.path.insert(0, '/home/lgpu0003/.conda/envs/fact/bin/python.37/site-packages/torch/__init__.py')
# sys.path = ['', '/home/lgpu0003/.conda/envs/fact/lib/python37.zip', '/home/lgpu0003/.conda/envs/fact/lib/python3.7', '/home/lgpu0003/.conda/envs/fact/lib/python3.7/lib-dynload', '/home/lgpu0003/.conda/envs/fact/lib/python3.7/site-packages']
...
def read_data_sets(data_dir, one_hot = True, validation_size = 5000):
    ...
    train_images_raw, train_labels_raw, test_images_raw, test_labels_raw =         get_cifar10_raw_data(data_dir)
    train_images, train_labels, test_images, test_labels =         preprocess_cifar10_data(train_images_raw, train_labels_raw, test_images_raw, test_labels_raw)
...
#     ae_error = F.binary_cross_entropy(X_decoded, X_true)
    ...
    total_error = lam_class * class_error +                  lam_ae * ae_error +                   lam_1 * error_1 +                   lam_2 * error_2
...
def visualize_prototypes(model, epoch, save=True):
    ...
    # decode prototypes
    decoded_prototypes = model.decoder(encoded_prototypes_reshaped).cpu().detach().numpy()
...
# if WHICH_DATA_FLAG == "mnist_color":
#     search_path = glob.glob("../git2/FACT/Reproduction/saved_model/mnist_model_color28_*")
# if WHICH_DATA_FLAG == "mnist_rgb2gray":
#     search_path = glob.glob("../git2/FACT/Reproduction/saved_model/gray*")
...
#     loaded_model = torch.load(best_model,  map_location=torch.device(device))
